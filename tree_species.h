...
#ifndef tree_species_hpp
#define tree_species_hpp
...
public:
    /** TreeSpecies(species) is a empty constructor .
     */
    TreeSpecies();
    
    /** TreeSpecies(species) is a constructor that expects a string.
     *  The string must contain a tree species.
     */
    TreeSpecies (const string & species) ;
    
    /** TreeSpecies(species) is a copy constructor .
     */
    TreeSpecies(const TreeSpecies & copy_species);
    
    /** ~TreeeSpecies() is a destructor.
     *  removes all species from tree
     */
    virtual ~TreeSpecies () ;
...
protected:
    set<string> list_of_species;       // ordered set of species name
};

#endif /* tree_species_hpp */
