...
Data Dictionary for Input File:
 ...
 38         double latitude    Latitude of point, in decimal degrees
                               
 39         double longitude   Longitude of point, in decimal degrees
...
public:
     ...
     *                case insensitively.
     *  loops through species name and converts all caracters to lower to check
     *  if identical
     */
